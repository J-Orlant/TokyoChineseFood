...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 30, 2023 at 04:37 PM
...
(1, 0, NULL, '2023-03-10 05:38:19'),
(2, 0, '2022-02-19 04:44:00', '2023-03-10 05:38:17'),
...
(2, 'assets/gambar/MBOvTWachA7K3auzu2i9usJA9NxTiIBBZwJMOXAB.jpg', 'Pisang Coklat', 5000, 6, '2022-02-15 08:31:03', '2023-04-30 05:46:35'),
(3, 'assets/gambar/ezkA2RwWGVX17bauUqQaqAPBkUW73uLRXHXxdOl3.jpg', 'Gudeg Jawa', 10000, 25, '2022-02-16 03:24:01', '2023-04-30 05:46:35'),
...
(62, 2, 49, 2, 10000, 'DIBUAT', '2023-04-30 14:19:38', '2023-04-30 14:19:38'),
(63, 3, 49, 2, 20000, 'DIBUAT', '2023-04-30 14:19:38', '2023-04-30 14:19:38'),
(64, 3, 50, 2, 20000, 'DIBUAT', '2023-04-30 14:22:54', '2023-04-30 14:22:54');
...
(49, 'Jojo', 1, 30000, NULL, 'TERTUNDA', '2023-04-30 14:19:38', '2023-04-30 14:19:38'),
(50, 'we', 2, 0, NULL, 'TERTUNDA', '2023-04-30 14:22:54', '2023-04-30 14:22:54');
...
--
ALTER TABLE `pesanan`
  ADD CONSTRAINT `pesanan_ibfk_1` FOREIGN KEY (`transaksi_id`) REFERENCES `transaksi` (`id`),
...
--
ALTER TABLE `transaksi`
  ADD CONSTRAINT `transaksi_ibfk_1` FOREIGN KEY (`meja`) REFERENCES `meja` (`id`);
COMMIT;
